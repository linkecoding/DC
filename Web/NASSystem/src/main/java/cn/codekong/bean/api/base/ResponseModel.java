package cn.codekong.bean.api.base;
...
public class ResponseModel<M> implements Serializable {
    ...
    //请求参数错误-已存在账户
    public static final int ERROR_PARAMETERS_EXIST_EMAIL = 4002;
    ...
    public static <M> ResponseModel<M> buildHaveAccountError(){
        return new ResponseModel<M>(ERROR_PARAMETERS_EXIST_EMAIL, "Already have this account.");
    }
